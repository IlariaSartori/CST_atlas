create_dataset = function(tract, side_label, standardized = T, lambda_opt)
{
  n = length(tract$data)
  patient = rep (as.numeric(tract$case), n)
  ...
  temp = map(tract$data, get_curvature_torsion_fda3D_lambda_fixed, lambda= lambda_opt)       
  temp_matrix = NULL
